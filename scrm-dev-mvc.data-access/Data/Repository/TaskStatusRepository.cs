...
{
    public class TaskStatusRepository : Repository<scrm_dev_mvc.Models.TaskStatus>, ITaskStatusRepository
    {
        private readonly ApplicationDbContext _db;
        public TaskStatusRepository(ApplicationDbContext db) : base(db)
        {
            _db = db;
        }
    }
